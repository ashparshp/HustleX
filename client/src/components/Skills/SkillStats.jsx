  ...
  const StatCard = ({ title, value, description, icon: Icon, color }) => {
    return (
      <motion.div
        ...
        "bg-white border-indigo-300/30 hover:border-indigo-300/60"} transition-all duration-300`
        }>
      ...
      <motion.div
        ...
        <div className="h-10 flex rounded-lg overflow-hidden mb-4">
          <motion.div
            ...
            className={`${
            isDark ? "bg-green-500" : "bg-green-600"} relative group`
            }>
          ...
          <motion.div
            ...
            className={`${
            isDark ? "bg-yellow-500" : "bg-yellow-600"} relative group`
            }>
          ...
          <motion.div
            ...
            className={`${
            isDark ? "bg-blue-500" : "bg-blue-600"} relative group`
            }>
  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        isDark ?
        "bg-black/80 border-indigo-500/30 hover:border-indigo-500/60" :
        "bg-white border-indigo-300/30 hover:border-indigo-300/60"} transition-all duration-300 text-center`
        }>
