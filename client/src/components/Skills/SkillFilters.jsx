      ...
      <motion.div
        ...
        <div className="relative">
          <input
            ...
            "bg-white text-gray-800 border-gray-300 focus:border-indigo-500"} focus:outline-none focus:ring-1 ${
              ...
              categories.map((category, index) => {
                ...
                return (
                  <motion.button
                    ...
                    "bg-indigo-100 border-indigo-200"} border shadow-sm` :

                    `${
                    isDark ?
                    "bg-gray-900 hover:bg-gray-800 border-gray-800" :
                    "bg-white hover:bg-gray-50 border-gray-200"} border shadow-sm`}`
