      ...
      <>
        <motion.div
          ...
          <div
            ...
            "bg-white border-indigo-300/50 group-hover:border-indigo-500"} flex flex-col sm:flex-row items-start sm:items-center gap-4`
            }>
            ...
            <div className="flex-grow min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-2">
                ...
                <span
                  ...
                  "bg-gray-100 text-gray-600"} cursor-pointer hover:opacity-80`
                  }
            ...
            <div className="w-full sm:w-52 flex-shrink-0">
              <div className="flex justify-between items-center text-sm mb-1">
                <span
                  className={`${
                  isDark ? "text-gray-400" : "text-gray-600"} text-xs`
                  }>
