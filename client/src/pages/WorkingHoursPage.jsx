      ...
      <section
        ...
        <div
          ...
          <motion.div
            ...
            "bg-white/90 border-indigo-300/50"} shadow-md`
            }>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
              <div>
                ...
                <div
                  ...
                  isDark ?
                  "from-white to-gray-500" :
                  "from-indigo-600 to-indigo-300"} mt-2 rounded-full`
                  } />
      ...
      <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-8">
          <div
            ...
            isDark ? "bg-gray-800/70" : "bg-gray-200/70"} animate-pulse mb-2`
            }>
          </div>
          <div
            className={`h-1 w-32 rounded-full ${
            isDark ? "bg-gray-800/70" : "bg-gray-200/70"} animate-pulse`
            }>
          </div>
        </div>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              <div
                ...
                isDark ? "bg-gray-800" : "bg-gray-200"} animate-pulse mb-2`
                }>
              </div>
              <div
